# SemanticVersion class definition taken from 
# https://raw.githubusercontent.com/PowerShell/PowerShell/4b9b0788ed28ea6d463ce857d1ed81bd4a977a59/src/System.Management.Automation/engine/PSVersionInfo.cs
[string]$SemanticVersionClassDefinition=@'
namespace InvokeVsBuild.Utils
{
    using System;
    ...
    public sealed class SemanticVersion : IComparable, IComparable<SemanticVersion>, IEquatable<SemanticVersion>
    {
        ...
        { 
            get { return _preReleaseLabel; }
            private set { _preReleaseLabel = value; }
        }
            ...
            internal Exception GetVersionParseException()
            {
                switch (_failure)
                {
                    ...
                    case ParseFailureKind.ArgumentOutOfRangeException:
                        return new ArgumentOutOfRangeException(_exceptionArgument, "ValidateRangeTooSmall");
...
Add-Type -TypeDefinition $SemanticVersionClassDefinition