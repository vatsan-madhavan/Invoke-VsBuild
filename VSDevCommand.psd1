#
# Module manifest for module 'VSDevCommand'
#
# Generated by: Vatsan Madhavan
#
# Generated on: 7/20/2020
#
...
- Invoke-VsDevCommand and Invoke-MsBuild allow selection of Visual Studio environment by specifying version, edition etc. Useful when multiple side-by-side installations of VS are present.
'@
...
PrivateData = @{
    PSData = @{
        ...
        Tags = @("Invoke-MsBuild", "MSBuild", "Invoke-VsDevCommand", "VisualStudio", "IDE", "vsdevcmd", "msbuild", "ivdc", "imb", "Invoke-Build", "ivb", "Build", "Developer_Command_Prompt" )
